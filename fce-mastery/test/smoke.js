...
ok(FCE.BANK.passages.p1.length >= 6 && FCE.BANK.passages.p2.length >= 8 && FCE.BANK.passages.p3.length >= 7, 'mock pools expanded: P1×'+FCE.BANK.passages.p1.length+' P2×'+FCE.BANK.passages.p2.length+' P3×'+FCE.BANK.passages.p3.length);
