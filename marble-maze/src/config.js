...
// =====================================================================
//  FX — "pro" presentation layer (bloom glow, sparks, speed streaks).
//  All self-contained; bloom uses the vendored postprocessing addons.
// =====================================================================
export const FX = {
  bloom:        { strength: 0.32, radius: 0.50, threshold: 0.90 },
  sparkSpeed:   11,    // marble speed above which friction sparks fly
  groundStreak: true,  // bright stretched light streak under the marble at speed
};
